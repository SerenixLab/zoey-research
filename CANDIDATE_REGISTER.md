...
| --- | --- | --- | --- | --- | --- | --- |
| `EXT-STATE-001` | `1` Semantic state and transitions | [`XTDB`](https://github.com/xtdb/xtdb) | `architecture-reference`, `pattern-extraction-source`, conditional `mechanism-candidate` | `source-reviewed` | Bounded temporal-projection source review complete. Closure of the V-003 Area 1 investigation is proposed pending corrected independent review; the wider family remains trigger-bound. The contingent experiment is inactive. No storage choice, dependency, clone, compatibility claim, or workbench is active. | [`external-capabilities/xtdb/`](external-capabilities/xtdb/ASSESSMENT.md) |
