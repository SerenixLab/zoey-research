...
| --- | --- | --- | --- | --- | --- | --- |
| `EXT-STATE-001` | `1` Semantic state and transitions | [`XTDB`](https://github.com/xtdb/xtdb) | `architecture-reference`, `pattern-extraction-source`, conditional `mechanism-candidate` | `source-reviewed` | Bounded temporal-projection source review complete. The V-003 Area 1 investigation is accepted closed after independent review; the wider family is dormant and trigger-bound. The contingent experiment is inactive. No storage choice, dependency, clone, compatibility claim, or workbench is active. | [`external-capabilities/xtdb/`](external-capabilities/xtdb/ASSESSMENT.md) |
