...
| --- | --- | --- | --- | --- | --- | --- |
| `EXT-STATE-001` | `1` Semantic state and transitions | XTDB | `architecture-reference`, `pattern-extraction-source`, conditional `mechanism-candidate` | `researching` | First deep-review candidate for bitemporal correction and historical projections; no storage choice, dependency, clone, or workbench is authorized. | [`external-capabilities/xtdb/`](external-capabilities/xtdb/ASSESSMENT.md) |
