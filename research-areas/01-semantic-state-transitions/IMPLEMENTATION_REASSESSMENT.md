...
found that the earlier review slices did not cover the complete implemented
frontier. It deterministically reproduced weak creator-pointer/result
multiplicity, direct and explanation attribution-envelope drift, partial
semantic mutation on processing failure, silent collapse of multiple outputs
to absence, mixed-claim explanation text bypass, and global terminal-family
cardinality mismatch. The implementing red-team also found analogous strict
